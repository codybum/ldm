...
@SuppressWarnings({"unused", "WeakerAccess", "UnusedReturnValue", "BooleanMethodIsAlwaysInverted", "SameParameterValue"})
public class Archiver {
    ...
    public Archiver(PluginBuilder plugin, String bagitType, String bagitHashing, boolean bagitHiddenFiles, String archiveCompression) {
    ...
    public boolean isBag(Path bag) {
        logger.trace("isBag('{}')", bag.toAbsolutePath());
